...
class Base:
    ...
    def __init__(self, id=None):
        """Initializing class Base with __init__"""
        if id is None:
            Base.__nb_objects += 1
    ...
    def from_json_string(json_string):
        """Returns a list of objects from json string"""
    ...
    def load_from_file(cls):
        """Loads a list of objects from file"""
    ...
    def save_to_file_csv(cls, list_objs):
        """Serializeing list_objs in CSV format and saves it to a file."""
    ...
    def draw(list_rectangles, list_squares):
        """A static method opening a window and draws all the instances"""
